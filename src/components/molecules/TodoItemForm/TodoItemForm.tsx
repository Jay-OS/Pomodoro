...
const TodoItemForm: React.FC<ITodoItemForm> = (props) => {
  ...
  if (createPomodoroFormFields.title.validation) {
      validation = {
          [createPomodoroFormFields.title.props.name]: createPomodoroFormFields.title.validation,
      };
  }
  if (createPomodoroFormFields.description.validation) {
      validation = {
          ...validation,
          [createPomodoroFormFields.description.props.name]: createPomodoroFormFields.description.validation,
      };
  }
