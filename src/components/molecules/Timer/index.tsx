...
const TimerController = () => {
    ...
    const timerExists = currentTimer.totalTimeMS !== undefined && currentTimer.ellapsedMS !== undefined;
    const timerRemainingMS = (currentTimer.totalTimeMS !== undefined && currentTimer.ellapsedMS !== undefined)
